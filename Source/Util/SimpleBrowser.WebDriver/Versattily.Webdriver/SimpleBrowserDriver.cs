...
{
	public class VersattilyDriver : IWebDriver, IHasInputDevices
	{
		public IBrowser _my;
        X509Certificate _certificate;

        public VersattilyDriver(X509Certificate certificate)
		{
            _certificate = certificate;
			_my = new BrowserWrapper(_certificate);
		}
		public VersattilyDriver(IBrowser browser)
		{
			_my = browser;
		}
