...
namespace SimpleBrowser
{
    ...
    public class Browser
    {
        ...
        private X509Certificate _certificado;
        ...
        public Browser(X509Certificate certificado, IWebRequestFactory requestFactory = null, string name = null, List<Browser> context = null)
        {
            ...
            {
                requestFactory = new DefaultRequestFactory(certificado);
            }
            ...
            else
            {
                ...
                do
                {
                    ...
                    try
                    {
                        ...
                        req.AdicionarCertificado(_certificado);
