...
namespace SimpleBrowser.Network
{
    ...
    internal class WebRequestWrapper : IHttpWebRequest
    {
        ...
        public WebRequestWrapper(Uri url, X509Certificate cert)
        {
            this.AdicionarCertificado(cert);
            this.webRequest = (HttpWebRequest)HttpWebRequest.Create(url);
            this.webRequest.ClientCertificates.Add(cert);
        }
        ...
        public IHttpWebResponse GetResponse()
        {
            ...
            try
            {
                this.webRequest.ClientCertificates.Add(_certificate);
        ...
        public void AdicionarCertificado(X509Certificate certificate)
        {
        ...
        Stream IHttpWebRequest.GetRequestStream()
        {
            return this.webRequest.GetRequestStream();
        }
