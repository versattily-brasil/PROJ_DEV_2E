// -----------------------------------------------------------------------
// <copyright file="ObjectExtensions.cs" company="SimpleBrowser">
...
namespace SimpleBrowser
{
    ...
    public static class ObjectExtensions
    {
        ...
        public static NameValueCollection ToNameValueCollection(this object o)
        {
            ...
            foreach (PropertyInfo p in o.GetType().GetProperties(BindingFlags.GetProperty | BindingFlags.SetProperty | BindingFlags.Public | BindingFlags.Instance))
            {
