...
{
    public class BotExecRepository : DapperRepository<BotExec>
    {
        private readonly OrquestradorContext _orquestradorContext;

        public BotExecRepository(OrquestradorContext orquestradorContext) : base(orquestradorContext.Connection)
        {
