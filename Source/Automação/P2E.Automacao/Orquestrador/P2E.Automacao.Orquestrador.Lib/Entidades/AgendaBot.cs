...
namespace P2E.Automacao.Orquestrador.Lib.Entidades
{
    ...
    public class AgendaBot
    {
        ...
        public eStatusExec? CD_ULTIMO_STATUS_EXEC_BOT { get { return BotProgramado?.OP_STATUS_BOT_EXEC; } }
        public int? CD_ULTIMA_EXEC_BOT { get { return BotProgramado?.CD_BOT_EXEC; } }
