...
namespace P2E.SSO.Tests.Rotina
{
    ...
    public class TesteRotina
    {
        ...
        {
            var rotina = new Domain.Entities.Rotina(String.Empty, "Descrição da Rotina 1", eTipoRotina.Cadastrar);
        ...
        {
            var rotina = new Domain.Entities.Rotina("Rotina 1", String.Empty, eTipoRotina.Cadastrar);
            Assert.AreEqual(false, rotina.Valid);
        }
        ...
        {
            var rotina = new Domain.Entities.Rotina("Rotina 1", "Descrição da Rotina 1", 0);
            Assert.AreEqual(false, rotina.Valid);
        }
    }
}
